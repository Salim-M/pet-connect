            ...
            <main className="flex justify-center items-center h-screen -mt-16">
                ...
                <div className="space-y-7 px-4 w-full md:w-2/3 lg:w-2/5">
                    <div>
                        ...
                        <p className="font-light text-xl">Register an account at PetConnect!</p>
                    </div>
                        ...
                        {({ errors, touched, isSubmitting }) => (
                            <Form>
                                <div className="space-y-2">
                                    <div>
                                        <Field type="username" name="username" placeholder="Username" as={Input} />
                                ...
                                <Button loading={isSubmitting} type="submit" color="primary" className="w-full mt-6">Register</Button>
                            </Form>
                        )}
                    </Formik>
                    <p className="text-gray-800 text-md">Already have an account? <Link to="/auth/login" className="underline text-blue-400 hover:text-blue-600">Login</Link></p>
                </div>
